    ...
    <div style={{ 
      ...
      <nav style={{ 
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: '10px' }}>
           <div className="hover" style={{ width: '32px', height: '32px', background: '#4285F4', borderRadius: '8px', display: 'flex', alignItems: 'center', justifyContent: 'center', color: 'white', fontWeight: 'bold' }}><img src="src/LOGO.png"></div>
