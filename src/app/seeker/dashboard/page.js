...
export default function HomeTab() {
  ...
  const toggleTheme = () => {
@@ -21,12 +42,6 @@ export default function HomeTab() {
    localStorage.setItem('theme', next ? 'dark' : 'light');
  };
  const theme = {
    bg: isDarkMode ? '#1a1a1a' : '#f4f4f4',
    navBg: isDarkMode ? '#2d2d2d' : 'white',
@@ -40,17 +55,15 @@ export default function HomeTab() {
  // --- FILTER STATES ---
...
@@ -72,44 +85,15 @@ export default function HomeTab() {
  });
...
@@ -118,57 +102,57 @@ export default function HomeTab() {
        ...
        <button 
          ...
          <button 
            ...
            style={{ 
              ...
              border: 'none', 
              borderRadius: '20px', 
@@ -177,115 +161,51 @@ export default function HomeTab() {
              color: theme.textMain
            }}
          >
           <Filter size={16} />
